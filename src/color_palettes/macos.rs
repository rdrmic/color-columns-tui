...
// --- Gems ---
pub const GEM_RUBY: Color = byte_to_color(RASPBERRY);
pub const GEM_EMERALD: Color = byte_to_color(MINT);
pub const GEM_SAPPHIRE: Color = byte_to_color(TEAL);
pub const GEM_TOPAZ: Color = byte_to_color(YELLOW);
pub const GEM_AMETHYST: Color = byte_to_color(VIOLET);
pub const GEM_AMBER: Color = byte_to_color(ORANGE);
...
// --- UI & layout ---
pub const UI_CANVAS_BG: Color = byte_to_color(BLUE_DARK);
...
// --- Console messages ---
pub const CONSOLE_TEXT_INFO: Color = byte_to_color(GREEN);
pub const CONSOLE_TEXT_ERROR: Color = byte_to_color(RED_BRIGHT);
