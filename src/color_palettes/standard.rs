...
pub const STAT_LABEL_SCORE: Color = rgb_to_color(GREEN);
pub const STAT_LABEL_MAX_COMBO: Color = rgb_to_color(BLUE);
pub const STAT_LABEL_HIGHSCORE: Color = rgb_to_color(RED);
...
pub const UI_LEGEND_ACTION: Color = rgb_to_color(GRAY_LIGHT);
